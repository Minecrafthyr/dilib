...
execute if score power dilib..input matches ..-1 run return run function dilib:func/io/math/power/-1

execute if score power dilib..input matches 0 run return run function dilib:func/io/math/power/0
